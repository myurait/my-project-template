...
- Determine the scope of the work and verify prerequisites.
...
- Add newly discovered issues or future tasks.
...
4. If quality check passes: execute remaining batches.
